...
if(isset($_SESSION['ADMIN']) || isset($_SESSION['COADMIN']) || (isset($_SESSION['TEACHER']) && $Status==1)){
?>
<center>
    <h3 class="font-h">Student Table</h3>
</center>
...
<div class="left-element font-h ">
    <h5 id="filter" style="margin-right: 3px;color:black"><select class="form-control" style="width: fit-content; margin-left: 5px;" id="page_num">
        <?php   
...
// PAGINATION
        ...
        $("#student_data_cont").on("click", '.block_stu_rec', function () {
            var id = $(this).data("id1");
            var child = $(this);
        ...
        $("#student_data_cont").on("click",".pic_container",function(){
...
<?php
 ...
 <img width="100%" height="auto" src="https://media.licdn.com/dms/image/D4D12AQEvlwvk_5jSBw/article-cover_image-shrink_600_2000/0/1714975705046?e=2147483647&v=beta&t=SSIjJpE29SKs3_amDcg2HY3bYhUaR145LScDJaJ5enk">   
